...
ControLeo_MAX31855::ControLeo_MAX31855(void)
{
...
*******************************************************************************/	
double	ControLeo_MAX31855::readThermocouple(unit_t	unit)
{
	unsigned long data;
	double temperature;
...
*
*******************************************************************************/
double	ControLeo_MAX31855::readJunction(unit_t	unit)
{
	double	temperature;
	unsigned long data;
...
*				
*******************************************************************************/
unsigned long ControLeo_MAX31855::readData()
{
	int bitCount;
	unsigned long data;
